      ...
      <div className="contact-container">
        <div className="contact-left">
          ...
          <span data-text="Twitter">
            <a
              href="https://twitter.com/SilonRajthala"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <span data-text="Instagram">
            <a
              href="https://www.instagram.com/itzmesilon__"
              target="_blank"
              rel="noopener noreferrer"
            >
        ...
        <div className="contact-right">
          ...
          <span
            ...
            data-text="Mail: seelon.rajthala.7@gmail.com"
          >
            <a
              href="https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&to=seelon.rajthala.7@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <span data-text="Phone: +977 9803298969">
            <a
              ...
              rel="noopener noreferrer"
            >
              <FontAwesomeIcon icon={faPhoneAlt} flip="horizontal" size="3x" />
            </a>
          </span>
