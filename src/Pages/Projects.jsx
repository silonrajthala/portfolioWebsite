  ...
  return (
    <div className="projects-container">
      ...
      <div className="project0">
        <div className="project-intro">
          ...
          <div className="project-intro-body">
            <h3>
              A Fitness website is a fitness information, class schedules,
              membership options, and tools to help users achieve their fitness
              goals{" "}
            </h3>
          </div>
      ...
      <div className="project3">
        <div className="project-intro">
          <div className="project-intro-head">Ecommerce</div>
          <div className="project-intro-body">
            <h3>
              Explore Fashion Store, your go-to online destination for exquisite
              clothing choices. Discover fashionable attire for all ages,
              benefit from convenient delivery, and enjoy a hassle-free exchange
              policy, all ensuring a delightful shopping experience.{" "}
            </h3>
          </div>
          <div className="project-intro-tail">
            <div className="react">
      ...
      <div className="project2">
        <div className="project-intro">
          ...
          <div className="project-intro-body">
            <h3>A simple Webiste which is under development</h3>
          </div>
          <div className="project-intro-tail">
            <div className="react">
              <div>Flutter</div>
